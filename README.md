...
<!-- c = 7
You have the addition operator that adds and the '=' that sets a value to a variable. -->
...
<!-- x = 3, y = 10
Both the x and y get assigned new values when the script is run.-->
...
<!-- weather = "sunny"
True
The first line sets the weather variable to "sunny" and the second line checks to see if weather is equal to "sunny" which is true. -->
