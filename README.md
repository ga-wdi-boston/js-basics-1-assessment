...
- null
  - let x = null
- undefined
  - calling a function, say y, that hasn't been declared.
...
The Value of c will be 7. This expression says to set c equal to the sum of the current values of c and d.
...
x = 3 and y = 10. The variables don't change but their values do.
...
- let weather creates a variable with no set value.
- weather = "sunny" sets weather equal to the string "sunny"
- the final statement tests to see if the value of weather is exactly "sunny". It will return true.
